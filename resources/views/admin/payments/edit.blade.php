    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.payments.update", [$payment->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('payment_due_date') ? 'is-invalid' : '' }}" type="text" name="payment_due_date" id="payment_due_date" value="{{ old('payment_due_date', $payment->payment_due_date) }}" required>
